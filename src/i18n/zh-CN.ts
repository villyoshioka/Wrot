...
const zhCN = {
  ...
  "settings.item.toolbarEdit.name": "显示工具栏编辑按钮",
  "settings.item.toolbarEdit.desc": "开启后，工具栏菜单中会加入编辑工具栏的项目。",
  "settings.item.resetToolbar.name": "重置工具栏",
  "settings.item.resetToolbar.desc": "将工具栏的顺序和显示恢复为初始状态。",
  "settings.item.resetToolbar.button": "重置",
  // Shown on the same row after the first press, in place of the label above.
  "settings.item.resetToolbar.confirm": "再按一次以重置",

  "view.toolbarAction.image": "图片",
  "view.toolbarAction.embed": "嵌入",
  "view.toolbarAction.bold": "粗体",
  "view.toolbarAction.italic": "斜体",
  "view.toolbarAction.list": "列表",
  "view.toolbarAction.check": "待办列表",
  "view.toolbarAction.ol": "编号列表",
  "view.toolbarAction.more": "更多",
  "view.toolbarEdit.done": "确定",
  "view.toolbarEdit.cancel": "取消编辑工具栏",

  "view.formatMenu.editToolbar": "编辑工具栏",
