...
const pt = {
  ...
  "settings.item.openOnStartup.desc": "Se ativado, o Wrot vem para a frente ao iniciar o Obsidian.",
  ...
  "settings.item.toolbarEdit.name": "Mostrar o botão de edição da barra de ferramentas",
  "settings.item.toolbarEdit.desc": "Quando ativado, o menu da barra ganha uma entrada para editá-la.",
  "settings.item.resetToolbar.name": "Redefinir a barra de ferramentas",
  "settings.item.resetToolbar.desc": "Restaura a ordem e a visibilidade da barra de ferramentas ao estado inicial.",
  "settings.item.resetToolbar.button": "Redefinir",
  // Shown on the same row after the first press, in place of the label above.
  "settings.item.resetToolbar.confirm": "Pressione novamente para redefinir",
  ...
  "view.toolbarAction.more": "Mais",
  "view.toolbarEdit.done": "Confirmar",
  "view.toolbarEdit.cancel": "Cancelar a edição da barra de ferramentas",

  "view.formatMenu.editToolbar": "Editar a barra de ferramentas",
