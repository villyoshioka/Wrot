...
const zhTW = {
  ...
  "settings.item.headerDateFormat.desc": "可以使用 YYYY, MM, DD 等。 \n留空則恢復成預設值。",

  "settings.item.timestampFormat.name": "時間戳記顯示格式",
  "settings.item.timestampFormat.desc": "可以使用 YYYY, MM, DD, HH, mm, ss。",

  "settings.item.bgColorLight.name": "背景顏色（淺色模式）",
  "settings.item.bgColorLight.desc": "用於貼文與輸入框。",
  "settings.item.textColorLight.name": "文字顏色（淺色模式）",
  "settings.item.textColorLight.desc": "用於文字與圖示。",
  "settings.item.bgColorDark.name": "背景顏色（深色模式）",
  "settings.item.bgColorDark.desc": "用於貼文與輸入框。",
  "settings.item.textColorDark.name": "文字顏色（深色模式）",
  "settings.item.textColorDark.desc": "用於文字與圖示。",

  "settings.item.submitLabel.name": "發佈按鈕文字",
  "settings.item.submitLabel.desc": "留空則僅顯示圖示（僅當已設定圖示時）。",
  ...
  "settings.item.showCalendarButton.desc": "開啟後，可從日期導覽列跳轉至任意日期。",

  "settings.item.showPostDelete.name": "顯示刪除按鈕",
  "settings.item.showPostDelete.desc": "開啟後，筆記選單中會增加刪除按鈕。 \n刪除後無法復原。附加的圖片不會被刪除。",

  "settings.item.useCustomAttachmentFolder.name": "指定圖片儲存位置",
  "settings.item.useCustomAttachmentFolder.desc": "僅適用於從 Wrot 加入的圖片。",
  ...
  "settings.tagRule.bg.desc": "用於貼文的背景。",
  "settings.tagRule.fg.name": "文字顏色",
  "settings.tagRule.fg.desc": "標籤、連結、URL 由強調色設定。",
  "settings.tagRule.accent.name": "強調色",
  "settings.tagRule.accent.desc": "未設定時使用主題的強調色。",
  "settings.tagRule.sub.name": "輔助色",
  "settings.tagRule.sub.desc": "時間戳記、清單標記等的顏色。 \n未設定時自動計算。",
