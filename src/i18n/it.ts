...
const it = {
  ...
  "settings.item.toolbarEdit.name": "Mostra il pulsante di modifica della barra degli strumenti",
  "settings.item.toolbarEdit.desc": "Quando è attivo, il menu della barra ottiene una voce per modificarla.",
  "settings.item.resetToolbar.name": "Reimposta la barra degli strumenti",
  "settings.item.resetToolbar.desc": "Riporta l'ordine e la visibilità della barra degli strumenti allo stato iniziale.",
  "settings.item.resetToolbar.button": "Reimposta",
  // Shown on the same row after the first press, in place of the label above.
  "settings.item.resetToolbar.confirm": "Premi di nuovo per reimpostare",
  ...
  "view.toolbarAction.list": "Elenco",
  "view.toolbarAction.check": "Elenco di controllo",
  "view.toolbarAction.ol": "Elenco numerato",
  "view.toolbarAction.more": "Altro",
  "view.toolbarEdit.done": "Conferma",
  "view.toolbarEdit.cancel": "Annulla la modifica della barra degli strumenti",

  "view.formatMenu.editToolbar": "Modifica la barra degli strumenti",
