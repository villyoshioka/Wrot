...
const de = {
  ...
  "settings.item.toolbarEdit.name": "Bearbeiten-Schaltfläche der Symbolleiste anzeigen",
  "settings.item.toolbarEdit.desc": "Wenn aktiviert, erhält das Menü der Symbolleiste einen Eintrag zum Bearbeiten.",
  "settings.item.resetToolbar.name": "Symbolleiste zurücksetzen",
  "settings.item.resetToolbar.desc": "Setzt Reihenfolge und Sichtbarkeit der Symbolleiste auf den Ausgangszustand zurück.",
  "settings.item.resetToolbar.button": "Zurücksetzen",
  // Shown on the same row after the first press, in place of the label above.
  "settings.item.resetToolbar.confirm": "Zum Zurücksetzen erneut drücken",
  ...
  "view.toolbarAction.more": "Mehr",
  "view.toolbarEdit.done": "Bestätigen",
  "view.toolbarEdit.cancel": "Bearbeiten der Symbolleiste abbrechen",

  "view.formatMenu.editToolbar": "Symbolleiste bearbeiten",
