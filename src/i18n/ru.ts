...
const ru = {
  ...
  "settings.item.toolbarEdit.name": "Показывать кнопку настройки панели",
  "settings.item.toolbarEdit.desc": "Когда включено, в меню панели появляется пункт для её настройки.",
  "settings.item.resetToolbar.name": "Сбросить панель инструментов",
  "settings.item.resetToolbar.desc": "Возвращает порядок и видимость кнопок панели к исходному состоянию.",
  "settings.item.resetToolbar.button": "Сбросить",
  // Shown on the same row after the first press, in place of the label above.
  "settings.item.resetToolbar.confirm": "Нажмите ещё раз для сброса",

  "view.toolbarAction.image": "Изображение",
  "view.toolbarAction.embed": "Вставка",
  "view.toolbarAction.bold": "Полужирный",
  "view.toolbarAction.italic": "Курсив",
  "view.toolbarAction.list": "Список",
  "view.toolbarAction.check": "Список задач",
  "view.toolbarAction.ol": "Нумерованный список",
  "view.toolbarAction.more": "Ещё",
  "view.toolbarEdit.done": "Подтвердить",
  "view.toolbarEdit.cancel": "Отменить настройку панели",

  "view.formatMenu.editToolbar": "Настроить панель",
