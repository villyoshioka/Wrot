...
const es = {
  ...
  "settings.item.openOnStartup.name": "Abrir al iniciar",
  "settings.item.openOnStartup.desc": "Si se activa, Wrot pasa al frente al iniciar Obsidian.",
  ...
  "settings.item.toolbarEdit.name": "Mostrar el botón de edición de la barra de herramientas",
  "settings.item.toolbarEdit.desc": "Cuando está activado, el menú de la barra incluye una entrada para editarla.",
  "settings.item.resetToolbar.name": "Restablecer la barra de herramientas",
  "settings.item.resetToolbar.desc": "Devuelve el orden y la visibilidad de la barra de herramientas a su estado inicial.",
  ...
  "view.toolbarAction.embed": "Insertar",
  "view.toolbarAction.bold": "Negrita",
  "view.toolbarAction.italic": "Cursiva",
  "view.toolbarAction.list": "Lista",
  "view.toolbarAction.check": "Lista de tareas",
  "view.toolbarAction.ol": "Lista numerada",
  "view.toolbarAction.more": "Más",
  "view.toolbarEdit.done": "Confirmar",
  "view.toolbarEdit.cancel": "Cancelar la edición de la barra de herramientas",

  "view.formatMenu.editToolbar": "Editar la barra de herramientas",
