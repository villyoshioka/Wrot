...
const fr = {
  ...
  "settings.item.openOnStartup.desc": "Si activé, Wrot passe au premier plan au démarrage d'Obsidian.",
  ...
  "settings.item.toolbarEdit.name": "Afficher le bouton de modification de la barre d'outils",
  "settings.item.toolbarEdit.desc": "Une fois activé, le menu de la barre reçoit une entrée pour la modifier.",
  "settings.item.resetToolbar.name": "Réinitialiser la barre d'outils",
  "settings.item.resetToolbar.desc": "Rétablit l'ordre et l'affichage de la barre d'outils à leur état initial.",
  "settings.item.resetToolbar.button": "Réinitialiser",
  // Shown on the same row after the first press, in place of the label above.
  "settings.item.resetToolbar.confirm": "Appuyez à nouveau pour réinitialiser",

  "view.toolbarAction.image": "Image",
  "view.toolbarAction.embed": "Intégrer",
  "view.toolbarAction.bold": "Gras",
  "view.toolbarAction.italic": "Italique",
  "view.toolbarAction.list": "Liste",
  "view.toolbarAction.check": "Liste de tâches",
  "view.toolbarAction.ol": "Liste numérotée",
  "view.toolbarAction.more": "Plus",
  "view.toolbarEdit.done": "Confirmer",
  "view.toolbarEdit.cancel": "Annuler la modification de la barre d'outils",

  "view.formatMenu.editToolbar": "Modifier la barre d'outils",
