...
const ko = {
  ...
  "settings.item.toolbarEdit.desc": "켜면 도구 모음 메뉴에 편집 항목이 추가됩니다.",
  "settings.item.resetToolbar.name": "도구 모음 초기화",
  "settings.item.resetToolbar.desc": "도구 모음의 순서와 표시를 처음 상태로 되돌립니다.",
  "settings.item.resetToolbar.button": "초기화",
  // Shown on the same row after the first press, in place of the label above.
  "settings.item.resetToolbar.confirm": "다시 누르면 초기화",

  "view.toolbarAction.image": "이미지",
  "view.toolbarAction.embed": "임베드",
  "view.toolbarAction.bold": "굵게",
  "view.toolbarAction.italic": "기울임",
  "view.toolbarAction.list": "목록",
  "view.toolbarAction.check": "체크리스트",
  "view.toolbarAction.ol": "번호 목록",
  "view.toolbarAction.more": "더 보기",
  "view.toolbarEdit.done": "확정",
  "view.toolbarEdit.cancel": "도구 모음 편집 취소",
